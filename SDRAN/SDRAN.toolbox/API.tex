...
\@x{}\moduleLeftDash\@xx{ {\MODULE} API}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANTS} OK ,\, Error}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} e2apServers ,\, e2apConns}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} e2tServers ,\, e2tConns}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} topoServers ,\, topoConns}%
\@pvspace{8.0pt}%
\@x{ API \.{\defeq} {\INSTANCE} Protocols}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 13 16:33:53 \ensuremath{PDT} 2021 by
 \ensuremath{jordanhalterman
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Aug} 13
 01:24:02 \ensuremath{PDT} 2021 by \ensuremath{jordanhalterman
}%
\end{cpar}%
\end{lcom}%
\end{document}
