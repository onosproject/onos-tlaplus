...
\@x{}\moduleLeftDash\@xx{ {\MODULE} Topo}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} API}%
\@pvspace{8.0pt}%
...
\@pvspace{8.0pt}%
\@x{\@s{12.29} Create ( m )\@s{2.19} \.{\defeq} [ status \.{\mapsto} OK ]}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} Update ( m ) \.{\defeq} [ status \.{\mapsto} OK ]}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} Delete ( m )\@s{2.95} \.{\defeq} [ status \.{\mapsto} OK ]}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} Get ( m ) \.{\defeq} [ status \.{\mapsto} OK ]}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} List ( m ) \.{\defeq} [ status \.{\mapsto} OK ]}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} Watch ( m ) \.{\defeq} [ status \.{\mapsto} OK ]}%
\@pvspace{8.0pt}%
...
\@pvspace{8.0pt}%
\@x{\@s{12.29} HandleCreateRequest ( c ,\, m ) \.{\defeq}}%
\@x{\@s{28.69} \.{\land} \.{\LET} r \.{\defeq} Store {\bang} Create ( m )}%
 \@x{\@s{39.81} \.{\IN} API {\bang} Topo {\bang} Server {\bang} Send {\bang}
 CreateResponse ( c ,\, r )}%
\@x{\@s{28.69} \.{\land} {\UNCHANGED} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} HandleUpdateRequest ( c ,\, m ) \.{\defeq}}%
\@x{\@s{28.69} \.{\land} \.{\LET} r \.{\defeq} Store {\bang} Update ( m )}%
 \@x{\@s{39.81} \.{\IN} API {\bang} Topo {\bang} Server {\bang} Send {\bang}
 UpdateResponse ( c ,\, r )}%
\@x{\@s{28.69} \.{\land} {\UNCHANGED} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} HandleDeleteRequest ( c ,\, m ) \.{\defeq}}%
\@x{\@s{28.69} \.{\land} \.{\LET} r \.{\defeq} Store {\bang} Delete ( m )}%
 \@x{\@s{39.81} \.{\IN} API {\bang} Topo {\bang} Server {\bang} Send {\bang}
 DeleteResponse ( c ,\, r )}%
\@x{\@s{28.69} \.{\land} {\UNCHANGED} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} HandleGetRequest ( c ,\, m ) \.{\defeq}}%
\@x{\@s{28.69} \.{\land} \.{\LET} r \.{\defeq} Store {\bang} Get ( m )}%
 \@x{\@s{39.81} \.{\IN} API {\bang} Topo {\bang} Server {\bang} Send {\bang}
 GetResponse ( c ,\, r )}%
\@x{\@s{28.69} \.{\land} {\UNCHANGED} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} HandleListRequest ( c ,\, m ) \.{\defeq}}%
\@x{\@s{28.69} \.{\land} \.{\LET} r \.{\defeq} Store {\bang} List ( m )}%
 \@x{\@s{39.81} \.{\IN} API {\bang} Topo {\bang} Server {\bang} Send {\bang}
 ListResponse ( c ,\, r )}%
\@x{\@s{28.69} \.{\land} {\UNCHANGED} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} HandleWatchRequest ( c ,\, m ) \.{\defeq}}%
\@x{\@s{28.69} \.{\land} \.{\LET} r \.{\defeq} Store {\bang} Watch ( m )}%
 \@x{\@s{39.81} \.{\IN} API {\bang} Topo {\bang} Server {\bang} Send {\bang}
 WatchResponse ( c ,\, r )}%
\@x{\@s{28.69} \.{\land} {\UNCHANGED} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{12.29} Next \.{\defeq}}%
 \@x{\@s{24.59} \.{\lor} \E\, s\@s{0.25} \.{\in} Nodes \.{:} API {\bang} Topo
 {\bang} Server {\bang} Serve ( s )}%
 \@x{\@s{24.59} \.{\lor} \E\, s\@s{0.25} \.{\in} API {\bang} Topo {\bang}
 Servers \.{:} API {\bang} Topo {\bang} Server {\bang} Stop ( s )}%
 \@x{\@s{24.59} \.{\lor} \E\, c \.{\in} API {\bang} Topo {\bang} Connections
 \.{:}}%
 \@x{\@s{42.93} \.{\lor} API {\bang} Topo {\bang} Server {\bang} Receive
 {\bang} CreateRequest ( c ,\, HandleCreateRequest )}%
 \@x{\@s{42.93} \.{\lor} API {\bang} Topo {\bang} Server {\bang} Receive
 {\bang} UpdateRequest ( c ,\, HandleUpdateRequest )}%
 \@x{\@s{42.93} \.{\lor} API {\bang} Topo {\bang} Server {\bang} Receive
 {\bang} DeleteRequest ( c ,\, HandleDeleteRequest )}%
 \@x{\@s{42.93} \.{\lor} API {\bang} Topo {\bang} Server {\bang} Receive
 {\bang} GetRequest ( c ,\, HandleGetRequest )}%
 \@x{\@s{42.93} \.{\lor} API {\bang} Topo {\bang} Server {\bang} Receive
 {\bang} ListRequest ( c ,\, HandleListRequest )}%
 \@x{\@s{42.93} \.{\lor} API {\bang} Topo {\bang} Server {\bang} Receive
 {\bang} WatchRequest ( c ,\, HandleWatchRequest )}%
\@pvspace{8.0pt}%
\@x{\@s{12.29}}\bottombar\@xx{}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 13 16:35:46 \ensuremath{PDT} 2021 by
 \ensuremath{jordanhalterman
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Aug} 13
 09:50:50 \ensuremath{PDT} 2021 by \ensuremath{jordanhalterman
}%
\end{cpar}%
\end{lcom}%
\end{document}
