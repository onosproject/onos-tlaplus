...
\@x{}\moduleLeftDash\@xx{ {\MODULE} E2T}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} API}%
\@pvspace{8.0pt}%
...
\@x{ {\CONSTANT} Nodes}%
\@pvspace{8.0pt}%
\@x{ {\ASSUME} \.{\land} IsFiniteSet ( Nodes )}%
\@x{\@s{38.24} \.{\land} \A\, n \.{\in} Nodes \.{:} n \.{\in} {\STRING}}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{\@s{12.29}}\moduleLeftDash\@xx{ {\MODULE} Store}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} CreateSubscription ( s ) \.{\defeq} [ status \.{\mapsto} OK ]}%
\@pvspace{8.0pt}%
 \@x{\@s{12.29} DeleteSubscription ( s )\@s{0.75} \.{\defeq} [ status
 \.{\mapsto} OK ]}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} Init\@s{4.12} \.{\defeq} {\TRUE}}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} Next \.{\defeq} {\FALSE}}%
\@pvspace{8.0pt}%
\@x{\@s{12.29}}\bottombar\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\LOCAL} Store \.{\defeq} {\INSTANCE} Store}%
\@pvspace{8.0pt}%
\@x{\@s{12.29}}\moduleLeftDash\@xx{ {\MODULE} NB}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} HandleSubscribeRequest ( c ,\, m ) \.{\defeq}}%
 \@x{\@s{28.69} \.{\land} \.{\LET} r \.{\defeq} Store {\bang}
 CreateSubscription ( m )}%
 \@x{\@s{39.81} \.{\IN} API {\bang} E2T {\bang} Server {\bang} Send {\bang}
 SubscribeResponse ( c ,\, r )}%
\@x{\@s{28.69} \.{\land} {\UNCHANGED} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} HandleUnsubscribeRequest ( c ,\, m ) \.{\defeq}}%
 \@x{\@s{28.69} \.{\land} \.{\LET} r \.{\defeq} Store {\bang}
 DeleteSubscription ( m )}%
 \@x{\@s{39.81} \.{\IN} API {\bang} E2T {\bang} Server {\bang} Send {\bang}
 UnsubscribeResponse ( c ,\, r )}%
\@x{\@s{28.69} \.{\land} {\UNCHANGED} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} HandleMessage ( c ,\, m ) \.{\defeq}}%
 \@x{\@s{24.59} \.{\land} \.{\lor} API {\bang} E2T {\bang} Server {\bang}
 Receive {\bang} SubscribeRequest ( c ,\, HandleSubscribeRequest )}%
 \@x{\@s{35.71} \.{\lor} API {\bang} E2T {\bang} Server {\bang} Receive
 {\bang} UnsubscribeRequest ( c ,\, HandleUnsubscribeRequest )}%
\@x{\@s{24.59} \.{\land} {\UNCHANGED} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} Init \.{\defeq}}%
\@x{\@s{24.59} \.{\land} {\TRUE}}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} Next \.{\defeq}}%
 \@x{\@s{24.59} \.{\lor} \E\, s\@s{0.25} \.{\in} Nodes \.{:} API {\bang} E2T
 {\bang} Server {\bang} Serve ( s )}%
 \@x{\@s{24.59} \.{\lor} \E\, s\@s{0.25} \.{\in} API {\bang} E2T {\bang}
 Servers \.{:} API {\bang} E2T {\bang} Server {\bang} Stop ( s )}%
 \@x{\@s{24.59} \.{\lor} \E\, c \.{\in} API {\bang} E2T {\bang} Connections
 \.{:}}%
 \@x{\@s{42.93} \.{\lor} API {\bang} E2T {\bang} Server {\bang} Receive
 {\bang} SubscribeRequest ( c ,\, HandleSubscribeRequest )}%
 \@x{\@s{42.93} \.{\lor} API {\bang} E2T {\bang} Server {\bang} Receive
 {\bang} UnsubscribeRequest ( c ,\, HandleUnsubscribeRequest )}%
\@pvspace{8.0pt}%
\@x{\@s{12.29}}\bottombar\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\LOCAL} NB \.{\defeq} {\INSTANCE} NB}%
\@pvspace{8.0pt}%
\@x{\@s{12.29}}\moduleLeftDash\@xx{ {\MODULE} SB}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} HandleE2SetupRequest ( c ,\, m ) \.{\defeq}}%
 \@x{\@s{28.69} \.{\land} API {\bang} E2AP {\bang} Server {\bang} Send {\bang}
 E2SetupResponse ( c ,\, [ status \.{\mapsto} OK ] )}%
\@x{\@s{28.69} \.{\land} {\UNCHANGED} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} Init \.{\defeq}}%
\@x{\@s{24.59} \.{\land} {\TRUE}}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} Next \.{\defeq}}%
 \@x{\@s{24.59} \.{\lor} \E\, s\@s{0.25} \.{\in} Nodes \.{:} API {\bang} E2AP
 {\bang} Server {\bang} Serve ( s )}%
 \@x{\@s{24.59} \.{\lor} \E\, s\@s{0.25} \.{\in} API {\bang} E2AP {\bang}
 Servers \.{:} API {\bang} E2AP {\bang} Server {\bang} Stop ( s )}%
 \@x{\@s{24.59} \.{\lor} \E\, c \.{\in} API {\bang} E2AP {\bang} Connections
 \.{:}}%
 \@x{\@s{42.93} \.{\lor} API {\bang} E2AP {\bang} Server {\bang} Receive
 {\bang} E2SetupRequest ( c ,\, HandleE2SetupRequest )}%
\@pvspace{8.0pt}%
\@x{\@s{12.29}}\bottombar\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\LOCAL} SB \.{\defeq} {\INSTANCE} SB}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@x{\@s{12.29} \.{\land} SB {\bang} Init}%
\@x{\@s{12.29} \.{\land} NB {\bang} Init}%
\@x{\@s{12.29} \.{\land} Store {\bang} Init}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{12.29} \.{\lor} SB {\bang} Next}%
\@x{\@s{12.29} \.{\lor} NB {\bang} Next}%
\@x{\@s{12.29} \.{\lor} Store {\bang} Next}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 13 16:35:38 \ensuremath{PDT} 2021 by
 \ensuremath{jordanhalterman
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Aug} 10
 04:55:45 \ensuremath{PDT} 2021 by \ensuremath{jordanhalterman
}%
\end{cpar}%
\end{lcom}%
\end{document}
