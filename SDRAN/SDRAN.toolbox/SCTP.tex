...
\@x{}\moduleLeftDash\@xx{ {\MODULE} SCTP}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
...
\@x{}\midbar\@xx{}%
\@pvspace{8.0pt}%
 \@x{ {\LOCAL} Min ( s )\@s{1.49} \.{\defeq} {\CHOOSE} x \.{\in} s \.{:} \A\,
 y \.{\in} s \.{:} x \.{\geq} y}%
\@pvspace{8.0pt}%
 \@x{ {\LOCAL} Max ( s ) \.{\defeq} {\CHOOSE} x \.{\in} s \.{:} \A\, y \.{\in}
 s \.{:} x \.{\leq} y}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLE} servers}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLE} conns}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} servers ,\, conns {\rangle}}%
\@pvspace{8.0pt}%
\@x{\@s{12.29}}\moduleLeftDash\@xx{ {\MODULE} Client}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} Connect ( c ,\, s ) \.{\defeq}}%
\@x{\@s{24.59} \.{\LET}\@s{3.77} maxId \.{\defeq} Max ( {\DOMAIN} conns )}%
 \@x{\@s{48.77} connId \.{\defeq} Min ( \{ i \.{\in} 1 \.{\dotdot} ( maxId
 \.{+} 1 ) \.{:} i \.{\notin} {\DOMAIN} conns \} )}%
 \@x{\@s{24.59} \.{\IN} conns \.{'} \.{=} conns \.{\,@@\,} ( connId
 \.{\colongt} [ id \.{\mapsto} connId ,\, src \.{\mapsto} c ,\, dst
 \.{\mapsto} s ,\, req \.{\mapsto} {\langle} {\rangle} ,\, res \.{\mapsto}
 {\langle} {\rangle} ] )}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} Disconnect ( c ) \.{\defeq}}%
 \@x{\@s{24.59} conns \.{'} \.{=} [ x \.{\in} {\DOMAIN} conns
 \.{\,\backslash\,} \{ c . id \} \.{\mapsto} conns [ x ] ]}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} Send ( c ,\, m ) \.{\defeq}}%
 \@x{\@s{24.59} conns \.{'} \.{=} [ conns {\EXCEPT} {\bang} [ c . id ] \.{=} [
 conns [ c . id ] {\EXCEPT} {\bang} . req \.{=} Append ( conns [ c . id ] .
 req ,\, m ) ] ]}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} Receive ( c ) \.{\defeq}}%
 \@x{\@s{24.59} conns \.{'} \.{=} [ conns {\EXCEPT} {\bang} [ c . id ] \.{=} [
 conns [ c . id ] {\EXCEPT} {\bang} . res \.{=} SubSeq ( conns [ c . id ] .
 res ,\, 2 ,\, Len ( conns [ c . id ] . res ) ) ] ]}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} Reply ( c ,\, m ) \.{\defeq}}%
 \@x{\@s{24.59} conns \.{'} \.{=} [ conns \.{'} {\EXCEPT} {\bang} [ c . id ]
 \.{=} [ conns \.{'} [ c . id ] {\EXCEPT} {\bang} . req \.{=} Append ( conns
 \.{'} [ c . id ] . req ,\, m ) ] ]}%
\@pvspace{8.0pt}%
 \@x{\@s{12.29} Handle ( c ,\, f ( \_ ,\, \_ ) ) \.{\defeq} Len ( c . res )
 \.{>} 0 \.{\land} f ( c ,\, c . res [ 1 ] )}%
\@pvspace{8.0pt}%
\@x{\@s{12.29}}\bottombar\@xx{}%
\@pvspace{8.0pt}%
\@x{ Client \.{\defeq} {\INSTANCE} Client}%
\@pvspace{8.0pt}%
 \@x{ Connections \.{\defeq} \{ conns [ c ] \.{:} c \.{\in} {\DOMAIN} conns
 \}}%
\@pvspace{8.0pt}%
\@x{\@s{12.29}}\moduleLeftDash\@xx{ {\MODULE} Server}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} Start ( s ) \.{\defeq}}%
\@x{\@s{24.59} \.{\land} servers \.{'} \.{=} servers \.{\cup} \{ s \}}%
\@x{\@s{24.59} \.{\land} {\UNCHANGED} {\langle} conns {\rangle}}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} Stop ( s ) \.{\defeq}}%
 \@x{\@s{24.59} \.{\land} servers \.{'} \.{=} servers \.{\,\backslash\,} \{ s
 \}}%
 \@x{\@s{24.59} \.{\land} conns \.{'} \.{=} [ c \.{\in} {\DOMAIN} conns
 \.{\,\backslash\,} \{ c \.{\in} conns \.{:} conns [ c ] . dst \.{\neq} s \}
 \.{\mapsto} conns [ c ] ]}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} Send ( c ,\, m ) \.{\defeq}}%
 \@x{\@s{24.59} conns \.{'} \.{=} [ conns {\EXCEPT} {\bang} [ c . id ] \.{=} [
 conns [ c . id ] {\EXCEPT} {\bang} . res \.{=} Append ( conns [ c . id ] .
 res ,\, m ) ] ]}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} Receive ( c ) \.{\defeq}}%
 \@x{\@s{24.59} conns \.{'} \.{=} [ conns {\EXCEPT} {\bang} [ c . id ] \.{=} [
 conns [ c . id ] {\EXCEPT} {\bang} . req \.{=} SubSeq ( conns [ c . id ] .
 req ,\, 2 ,\, Len ( conns [ c . id ] . req ) ) ] ]}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} Reply ( c ,\, m ) \.{\defeq}}%
 \@x{\@s{24.59} conns \.{'} \.{=} [ conns \.{'} {\EXCEPT} {\bang} [ c . id ]
 \.{=} [ conns \.{'} [ c . id ] {\EXCEPT} {\bang} . res \.{=} Append ( conns
 \.{'} [ c . id ] . res ,\, m ) ] ]}%
\@pvspace{8.0pt}%
 \@x{\@s{12.29} Handle ( c ,\, f ( \_ ,\, \_ ) ) \.{\defeq} Len ( c . req )
 \.{>} 0 \.{\land} f ( c ,\, c . req [ 1 ] )}%
\@pvspace{8.0pt}%
\@x{\@s{12.29}}\bottombar\@xx{}%
\@pvspace{8.0pt}%
\@x{ Servers \.{\defeq} servers}%
\@pvspace{8.0pt}%
\@x{ Server \.{\defeq} {\INSTANCE} Server}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@x{\@s{12.29} \.{\land} servers \.{=} \{ \}}%
 \@x{\@s{12.29} \.{\land} conns \.{=} [ c \.{\in} \{ \} \.{\mapsto} [ e2n
 \.{\mapsto} Nil ,\, e2t \.{\mapsto} Nil ,\, req \.{\mapsto} {\langle}
 {\rangle} ,\, res \.{\mapsto} {\langle} {\rangle} ] ]}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{12.29} \.{\lor} {\TRUE}}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 13 17:39:15 \ensuremath{PDT} 2021 by
 \ensuremath{jordanhalterman
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Aug} 13
 14:42:32 \ensuremath{PDT} 2021 by \ensuremath{jordanhalterman
}%
\end{cpar}%
\end{lcom}%
\end{document}
