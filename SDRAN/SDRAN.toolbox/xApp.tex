...
\@x{}\moduleLeftDash\@xx{ {\MODULE} xApp}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} API}%
\@pvspace{8.0pt}%
...
\@pvspace{8.0pt}%
\@x{\@s{12.29} SendSubscribeRequest ( c ) \.{\defeq}}%
 \@x{\@s{24.59} \.{\land} API {\bang} E2T {\bang} Client {\bang} Send {\bang}
 SubscribeRequest ( c ,\, [ foo \.{\mapsto}\@w{bar} ] )}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} HandleSubscribeResponse ( c ,\, m ) \.{\defeq}}%
\@x{\@s{24.59} \.{\land} {\UNCHANGED} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} SendUnsubscribeRequest ( c ) \.{\defeq}}%
 \@x{\@s{24.59} \.{\land} API {\bang} E2T {\bang} Client {\bang} Send {\bang}
 UnsubscribeRequest ( c ,\, [ foo \.{\mapsto}\@w{bar} ] )}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} HandleUnsubscribeResponse ( c ,\, m ) \.{\defeq}}%
\@x{\@s{24.59} \.{\land} {\UNCHANGED} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{12.29} Next \.{\defeq}}%
 \@x{\@s{24.59} \.{\lor} \E\, n \.{\in} Nodes ,\, s \.{\in} API {\bang} E2T
 {\bang} Servers \.{:} API {\bang} E2T {\bang} Client {\bang} Connect ( n ,\,
 s )}%
 \@x{\@s{24.59} \.{\lor} \E\, c\@s{1.22} \.{\in} API {\bang} E2T {\bang}
 Connections \.{:} API {\bang} E2T {\bang} Client {\bang} Disconnect ( c )}%
 \@x{\@s{24.59} \.{\lor} \E\, c\@s{1.22} \.{\in} API {\bang} E2T {\bang}
 Connections \.{:}}%
\@x{\@s{42.93} \.{\lor} SendSubscribeRequest ( c )}%
\@x{\@s{42.93} \.{\lor} SendUnsubscribeRequest ( c )}%
 \@x{\@s{42.93} \.{\lor} API {\bang} E2T {\bang} Client {\bang} Receive
 {\bang} SubscribeResponse ( c ,\, HandleSubscribeResponse )}%
 \@x{\@s{42.93} \.{\lor} API {\bang} E2T {\bang} Client {\bang} Receive
 {\bang} UnsubscribeResponse ( c ,\, HandleUnsubscribeResponse )}%
\@pvspace{8.0pt}%
\@x{\@s{12.29}}\bottombar\@xx{}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 13 16:35:43 \ensuremath{PDT} 2021 by
 \ensuremath{jordanhalterman
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Aug} 10
 04:55:35 \ensuremath{PDT} 2021 by \ensuremath{jordanhalterman
}%
\end{cpar}%
\end{lcom}%
\end{document}
