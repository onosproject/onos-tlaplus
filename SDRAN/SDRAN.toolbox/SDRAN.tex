...
\@x{}\moduleLeftDash\@xx{ {\MODULE} SDRAN}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} API}%
\@pvspace{8.0pt}%
...
\@pvspace{8.0pt}%
\@x{ {\CONSTANT} TopoNodes}%
\@pvspace{8.0pt}%
 \@x{ {\LOCAL} Topo \.{\defeq} {\INSTANCE} Topo {\WITH} Nodes \.{\leftarrow}
 TopoNodes}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANT} E2TNodes}%
\@pvspace{8.0pt}%
 \@x{ {\LOCAL} E2T \.{\defeq} {\INSTANCE} E2T {\WITH} Nodes \.{\leftarrow}
 E2TNodes}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANT} E2Nodes}%
\@pvspace{8.0pt}%
 \@x{ {\LOCAL} E2Node \.{\defeq} {\INSTANCE} E2Node {\WITH} Nodes
 \.{\leftarrow} E2Nodes}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANT} xApps}%
\@pvspace{8.0pt}%
 \@x{ {\LOCAL} xApp ( app ,\, nodes ) \.{\defeq} {\INSTANCE} xApp {\WITH} App
 \.{\leftarrow} app ,\, Nodes \.{\leftarrow} nodes}%
\@pvspace{8.0pt}%
\@x{ {\RECURSIVE} SetToSeq ( \_ )}%
\@x{ {\LOCAL} SetToSeq ( S ) \.{\defeq}}%
\@x{\@s{12.29} {\IF} Cardinality ( S ) \.{=} 0 \.{\THEN} {\langle} {\rangle}}%
\@x{\@s{12.29} \.{\ELSE}}%
\@x{\@s{24.59} \.{\LET}}%
\@x{\@s{36.89} x \.{\defeq} {\CHOOSE} x \.{\in} S \.{:} {\TRUE}}%
\@x{\@s{24.59} \.{\IN}}%
 \@x{\@s{36.89} {\langle} x {\rangle} \.{\circ} SetToSeq ( S
 \.{\,\backslash\,} \{ x \} )}%
\@pvspace{8.0pt}%
 \@x{ {\LOCAL} xAppVars \.{\defeq} SetToSeq ( \{ app \.{\in} {\DOMAIN} xApps
 \.{:} xApp ( app ,\, xApps [ app ] ) {\bang} vars \} )}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@x{\@s{12.29} \.{\land} API {\bang} E2AP {\bang} Init}%
\@x{\@s{12.29} \.{\land} API {\bang} E2T {\bang} Init}%
\@x{\@s{12.29} \.{\land} API {\bang} Topo {\bang} Init}%
\@x{\@s{12.29} \.{\land} Topo {\bang} Init}%
\@x{\@s{12.29} \.{\land} E2T {\bang} Init}%
\@x{\@s{12.29} \.{\land} E2Node {\bang} Init}%
 \@x{\@s{12.29} \.{\land} \A\, app \.{\in} {\DOMAIN} xApps \.{:} xApp ( app
 ,\, xApps [ app ] ) {\bang} Init}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{12.29} \.{\lor} \.{\land} API {\bang} E2AP {\bang} Next}%
 \@x{\@s{23.41} \.{\land} {\UNCHANGED} {\langle} API {\bang} E2T {\bang} vars
 ,\, API {\bang} Topo {\bang} vars ,\, Topo {\bang} vars ,\, E2T {\bang} vars
 ,\, E2Node {\bang} vars ,\, xAppVars {\rangle}}%
\@x{\@s{12.29} \.{\lor} \.{\land} API {\bang} E2T {\bang} Next}%
 \@x{\@s{23.41} \.{\land} {\UNCHANGED} {\langle} API {\bang} E2AP {\bang} vars
 ,\, API {\bang} Topo {\bang} vars ,\, Topo {\bang} vars ,\, E2T {\bang} vars
 ,\, E2Node {\bang} vars ,\, xAppVars {\rangle}}%
\@x{\@s{12.29} \.{\lor} \.{\land} API {\bang} Topo {\bang} Next}%
 \@x{\@s{23.41} \.{\land} {\UNCHANGED} {\langle} API {\bang} E2AP {\bang} vars
 ,\, API {\bang} E2T {\bang} vars ,\, Topo {\bang} vars ,\, E2T {\bang} vars
 ,\, E2Node {\bang} vars ,\, xAppVars {\rangle}}%
\@x{\@s{12.29} \.{\lor} \.{\land} Topo {\bang} Next}%
 \@x{\@s{23.41} \.{\land} {\UNCHANGED} {\langle} API {\bang} E2AP {\bang} vars
 ,\, API {\bang} E2T {\bang} vars ,\, API {\bang} Topo {\bang} vars ,\, E2T
 {\bang} vars ,\, E2Node {\bang} vars ,\, xAppVars {\rangle}}%
\@x{\@s{12.29} \.{\lor} \.{\land} E2T {\bang} Next}%
 \@x{\@s{23.41} \.{\land} {\UNCHANGED} {\langle} API {\bang} E2AP {\bang} vars
 ,\, API {\bang} E2T {\bang} vars ,\, API {\bang} Topo {\bang} vars ,\, Topo
 {\bang} vars ,\, E2Node {\bang} vars ,\, xAppVars {\rangle}}%
\@x{\@s{12.29} \.{\lor} \.{\land} E2Node {\bang} Next}%
 \@x{\@s{23.41} \.{\land} {\UNCHANGED} {\langle} API {\bang} E2AP {\bang} vars
 ,\, API {\bang} E2T {\bang} vars ,\, API {\bang} Topo {\bang} vars ,\, Topo
 {\bang} vars ,\, E2T {\bang} vars ,\, xAppVars {\rangle}}%
 \@x{\@s{12.29} \.{\lor} \.{\land} \E\, app \.{\in} {\DOMAIN} xApps \.{:} xApp
 ( app ,\, xApps [ app ] ) {\bang} Next}%
 \@x{\@s{23.41} \.{\land} {\UNCHANGED} {\langle} API {\bang} E2AP {\bang} vars
 ,\, API {\bang} E2T {\bang} vars ,\, API {\bang} Topo {\bang} vars ,\, Topo
 {\bang} vars ,\, E2T {\bang} vars ,\, E2Node {\bang} vars {\rangle}}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 13 17:43:45 \ensuremath{PDT} 2021 by
 \ensuremath{jordanhalterman
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Aug} 10
 04:53:48 \ensuremath{PDT} 2021 by \ensuremath{jordanhalterman
}%
\end{cpar}%
\end{lcom}%
\end{document}
