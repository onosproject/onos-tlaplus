...
\@x{}\moduleLeftDash\@xx{ {\MODULE} E2Node}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} API}%
\@pvspace{8.0pt}%
...
\@pvspace{8.0pt}%
\@x{\@s{12.29} SendE2SetupRequest ( c ) \.{\defeq}}%
 \@x{\@s{24.59} \.{\land} API {\bang} E2AP {\bang} Client {\bang} Send {\bang}
 E2SetupRequest ( c ,\, [ foo \.{\mapsto}\@w{bar} ] )}%
\@pvspace{8.0pt}%
\@x{\@s{12.29} HandleE2SetupResponse ( c ,\, m ) \.{\defeq}}%
...
\@x{\@s{12.29} Next \.{\defeq}}%
 \@x{\@s{24.59} \.{\lor} \E\, n \.{\in} Nodes ,\, s \.{\in} API {\bang} E2AP
 {\bang} Servers \.{:} API {\bang} E2AP {\bang} Client {\bang} Connect ( n
 ,\, s )}%
 \@x{\@s{24.59} \.{\lor} \E\, c\@s{1.22} \.{\in} API {\bang} E2AP {\bang}
 Connections \.{:} API {\bang} E2AP {\bang} Client {\bang} Disconnect ( c )}%
 \@x{\@s{24.59} \.{\lor} \E\, c\@s{1.22} \.{\in} API {\bang} E2AP {\bang}
 Connections \.{:}}%
\@x{\@s{42.93} \.{\lor} SendE2SetupRequest ( c )}%
 \@x{\@s{42.93} \.{\lor} API {\bang} E2AP {\bang} Client {\bang} Receive
 {\bang} E2SetupResponse ( c ,\, HandleE2SetupResponse )}%
\@pvspace{8.0pt}%
\@x{\@s{12.29}}\bottombar\@xx{}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 13 16:36:37 \ensuremath{PDT} 2021 by
 \ensuremath{jordanhalterman
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Aug} 10
 04:55:53 \ensuremath{PDT} 2021 by \ensuremath{jordanhalterman
}%
\end{cpar}%
\end{lcom}%
\end{document}
