...
TypeOK ==
   \A i \in DOMAIN proposal :
      /\ proposal[i].phase \in Phase
      /\ proposal[i].change.commit \in Status
      /\ proposal[i].change.apply \in Status
      ...
      /\ proposal[i].rollback.commit \in Status
      /\ proposal[i].rollback.apply \in Status
